			...
			<RightContainer>
				...
				<ChangePasswordContainer>
					<ChangePasswordCard onSubmit={onSubmit}>
						<Input value={form.password} name="password" onChange={updateForm} label="Current Password" type="password" />
						<Input value={form.newpassword} name="newpassword" onChange={updateForm} label="New Password" type="password" />
